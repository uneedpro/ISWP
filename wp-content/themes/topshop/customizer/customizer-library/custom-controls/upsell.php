...
class Customizer_Library_Upsell extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<div class="kaira-upsell">
            ...
            <div class="kaira-upsell-desc"><a href="<?php echo admin_url( 'themes.php?page=premium_upgrade' ); ?>" target="_blank"><?php echo __( 'See the premium features', 'topshop' ); ?></a></div>
		</div>
		<?php
	}
